...
import style from "../styles/UserProfileComment.module.css";
import api from "../api";
...
const Main = (props) => {
  ...
  return (
    <div
      className={`${style.main} ${props.admin && style.admin} ${
        props.admin && props.data.state && style.reacted
      }`}
    >
